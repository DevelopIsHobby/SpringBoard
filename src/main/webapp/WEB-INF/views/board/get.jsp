    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="modalRegisterBtn" class="btn btn-primary" data-dismiss="modal">Register</button>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        const bnoValue = '<c:url value="${board.bno}"/>'
        const replyUL = $(".chat")
